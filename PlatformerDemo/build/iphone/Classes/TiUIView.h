...
/**
 Base class for all PlatformerDemo views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the PlatformerDemo view hierarchy (such as wrapped iOS UIViews) was touched.
