...
//@interface PlatformerDemoObject : NSObject
//@end

@interface PlatformerDemoObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[PlatformerDemoObject class]])
		{
			for (NSString *key in [[(PlatformerDemoObject*)o modules] allKeys])
			{
