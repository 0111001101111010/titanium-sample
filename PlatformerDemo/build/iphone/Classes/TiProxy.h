...
//Rare exceptions to indicate a bug in the _platformerdemo code (Eg, function that a subclass should have implemented)
...
/**
 The base class for PlatformerDemo proxies.
 */
