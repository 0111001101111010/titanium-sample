...
@interface PlatformerDemoObject : KrollCoverageObject {
#else
@interface PlatformerDemoObject : KrollObject {
#endif
@private
...
extern NSString * PlatformerDemo$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	PlatformerDemoObject *_platformerdemo;
    KrollObject* console;
	BOOL shutdown;
