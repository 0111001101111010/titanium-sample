...
// in simulator we redefine to format for PlatformerDemo Developer console
...
{\
	NSString * exceptionName = [@"org.platformerdemo." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.platformerdemo";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIPlatformerDemoNativeItemNone = -1, 
	UIPlatformerDemoNativeItemSpinner = -2,
	UIPlatformerDemoNativeItemProgressBar = -3,
	
	UIPlatformerDemoNativeItemSlider = -4,
	UIPlatformerDemoNativeItemSwitch = -5,
	UIPlatformerDemoNativeItemMultiButton = -6,
	UIPlatformerDemoNativeItemSegmented = -7,
	
	UIPlatformerDemoNativeItemTextView = -8,
	UIPlatformerDemoNativeItemTextField = -9,
	UIPlatformerDemoNativeItemSearchBar = -10,
	
	UIPlatformerDemoNativeItemPicker = -11,
	UIPlatformerDemoNativeItemDatePicker = -12,
	
	UIPlatformerDemoNativeItemInfoLight = -13,
	UIPlatformerDemoNativeItemInfoDark = -14,
	
	UIPlatformerDemoNativeItemDisclosure = -15,
	
	UIPlatformerDemoNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all PlatformerDemo instances of
